...
db = mongoose.connect config.mongo.db, ->
  ...
  users = [
    { "email": "erid14@gmail.com", "password": "123" }
    { "email": "frank.xorjas@gmail.com", "password": "123" }
    { "email": "manuel.rojas.21@gmail.com", "password": "123" }
    { "email": "rfiatt996@gmail.com", "password": "123" }
  ]
